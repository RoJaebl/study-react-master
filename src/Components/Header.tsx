...
const searchVariants: Variants = {
	...
	animate: { x: -180, transition: { duration: 0.3 } },
};
...
function Header() {
	...
	const openSearch = () => {
		if (!searchOpen) {
			inputAnimation.start("animate");
			searchAnimation.start("animate");
		} else {
			inputAnimation.start("initial");
			searchAnimation.start("initial");
		}
